...
class TripTest {
    ...
    public void calculationAmountZero() {
        ...
        long amount = trip.calculationAmount(0, new TariffService()) / 100;
    ...
    public void calculationAmountNoBonus() {
            TripService trip = new TripService();
            long amount = trip.calculationAmount(25, new TariffService())/100;
    ...
    public void calculationAmountWithBonus() {
            TripService trip = new TripService();
            long amount = trip.calculationAmount(50, new TariffService())/100;
    ...
    public void calculationAmountWithLimitBonus() {
            TripService trip = new TripService();
            long amount = trip.calculationAmount(100, new TariffService())/100;
